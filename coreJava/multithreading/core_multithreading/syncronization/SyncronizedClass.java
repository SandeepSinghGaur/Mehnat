...
public class SyncronizedClass {
    ...
    public static void m3(String name) {
        System.out.println("static Synchronized m3 method executed by"+ name);
    }

    public synchronized void m4(String name) {
        System.out.println("static Synchronized m4 method executed by"+ name);
    }

    public void m5(String name) {
        System.out.println("static Synchronized m5 method executed by"+ name);
    }
